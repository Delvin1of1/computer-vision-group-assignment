...
save_path = '.\save_image_project_test02\';
...
Npoint   = 1500; % Keypoints number threshold, default: 5000
...
for k = 1:length(files1)
    ...
    if exist('matchment','var') && ~isempty(matchment) && isvalid(matchment)
        ...
        %file1(end-9:end)
        saveas(matchment, [save_path,'matchingResult-',file1(end-9:end-4),'.png'])
    end
    ...
    Imwrite(I3   , [save_path,'overlap-',file1(end-9:end-4),'.png']);
